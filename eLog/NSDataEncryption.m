...
{
    return [[plaintext dataUsingEncoding:NSUTF8StringEncoding] AES256EncryptWithKey];
    
}

- (NSString*) decryptData:(NSData*)ciphertext
{
    return [[NSString alloc] initWithData:[ciphertext AES256DecryptWithKey] encoding:NSUTF8StringEncoding];
}
